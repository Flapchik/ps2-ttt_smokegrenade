...
function PANEL:SetItem( item )
	...
	self.modelPanel:SetModel( Pointshop2.GetWeaponWorldModel( "weapon_ttt_smokegrenade" ) or "models/error.mdl" )
	local wep = weapons.GetStored("weapon_ttt_smokegrenade")	
...
vgui.Register( "DPointshopCustomInvIcon", PANEL, "DPointshopInventoryItemIcon" )